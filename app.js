...
function homeGuideMarkup() {
  ...
  <section class="home-guide" aria-labelledby="home-guide-title">
    ...
    <details><summary>跨時區玩家看到的時間會一樣嗎？</summary>
      <p>建立者會替約團表設定「團務時區」，月曆日期以該時區作為共同基準。每個早上、下午、晚上時段則會像 Discord 時間戳一樣，依你目前裝置的時區自動換算。</p>
      <p>頁面會同時標示團務基準時區與你的裝置時區；可成團結果與匯出檔也會使用你的當地時間。匯出結果另附 Discord 的 <code>&lt;t:時間戳&gt;</code>，貼進 Discord 後，每位成員會看到自己的當地時間。</p>
    </details>
